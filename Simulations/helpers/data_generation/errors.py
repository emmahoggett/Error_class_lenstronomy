...
class LensMassError():
    ...
    """
    def __init__(self, size:int, seed:int, percent:float, center_x:float = 0, center_y:float = 0, mass_param = None):
        """
    ...
    def add_error(self, index:int):
        ...
        kwargs_spemd = {'theta_E': self.metadata_error['MASS_PROFILE_theta_E'][index], 
                        'gamma': self.metadata_error['MASS_PROFILE_gamma'][index], 
                        'center_x': self.center_x, 'center_y': self.center_y, 
                        'e1':self.metadata_error['MASS_PROFILE_e1'][index], 
                        'e2': self.metadata_error['MASS_PROFILE_e2'][index]}  
        return [kwargs_spemd]
...
class SourceError():
    ...
    The default model configuration is the following :
        ...
        - Position angle, phi               : uniform distribution U(0,pi/2)
        """
    def __init__(self, size:int, seed:int, percent:float, source_param = None):
        """  
        ...
        self.metadata_error['SOURCE_PROFILE_center_y'] = self.metadata['SOURCE_PROFILE_center_y']
